...
#rmarkdown::render(paste(rootdir,"rmd/fourty_percent_cooperative_environment_degree2_rf_rank_all.Rmd", sep="/"))
      ...
      for(frac in c(0,-1,1)){
        ...
        fractionCoop = frac
          ...
          for(m in c(1:iterations)){
            ...
            coop_rp1 <- rbinom(n = N, size = 1, prob = 0.6) # Generate the original vector
