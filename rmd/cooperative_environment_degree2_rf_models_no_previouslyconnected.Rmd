...
#rmarkdown::render(paste(rootdir,"rmd/cooperative_environment_degree2_rf_models_no_previouslyconnected.Rmd", sep="/"))
...
model3 <- model3_no_previouslyconnected(redo=TRUE)
